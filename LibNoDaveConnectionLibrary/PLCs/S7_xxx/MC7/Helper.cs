...
namespace DotNetSiemensPLCToolBoxLibrary.PLCs.S7_xxx.MC7
{
    ...
    public static class Helper
    {
        ...
        /// <returns></returns>
        public static int GetParameterValueInt(string parameter)
        {
        ...
        /// <param name="parameter"></param>
        /// <returns></returns>
        public static byte[] GetParameterValueBytes(string parameter)
        {
        ...
        public static DateTime GetDateTimeFromDateString(string myString)
        {
        ...
        public static DateTime GetDateTimeFromTimeOfDayString(string myString)
        {
        ...
        public static DateTime GetDateTimeFromDateAndTimeString(string myString)
        {
        ...
        public static int GetIntFromBinString(string myString)
        {
            int val = 0;
        ...
        public static int GetIntFromHexString(string myString)
        {
        ...
        /// <param name="parameter"></param>
        /// <returns></returns>
        public static byte[] GetCallParameterByte(string parameter)
        {
            return null;
        }

        public static byte[] EncodePassword(string pwd)
        {
        ...
        public static byte[] GetIndirectBytesWord(string parameter) //For this:  [DBW3] [LW4] and so on... must be 3 Bytes. 1 for type DBW, DIW, LW
        {
        ...
        public static string GetLang(byte b)
        {
            ...
            switch (b)
            {
                ...
                default:
                    Result = "unbekannt(0x" + (b).ToString("X") + ")";
                    break;
            }
            return Result;
        }
