...
namespace DotNetSiemensPLCToolBoxLibrary.Projectfiles
{
    public static class Projects
    {
        ...
        public static void Dispose()
        {
            ...
            _createV21ProjectInstance = null;
            ...
            _attachV20ProjectInstance = null;
            _attachV21ProjectInstance = null;
            ...
            _attachV20ProjectInstanceWithFilename = null;
            _attachV21ProjectInstanceWithFilename = null;
        }
                ...
                if (_createV21ProjectInstance == null)
                {
                    lock (_lockObject)
                    {
                        if (_createV21ProjectInstance == null)
                        {
                            ...
                            {
                                throw new Exception("You can not open a project in V21 if you already have a project open in another version. You need to restart the Application!");
                            }
                            var path = Path.GetDirectoryName(Assembly.GetCallingAssembly().Location) ?? "";
